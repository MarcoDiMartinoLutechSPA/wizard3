		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#sapbtpwizard3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpwizard3-display": {
								"semanticObject": "sapbtpwizard3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.wizard3",
									"url": sap.ui.require.toUrl("sap/btp/wizard3")
								}
							}
						}
					}
